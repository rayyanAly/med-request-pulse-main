...
import { LayoutDashboard, Package, ShoppingCart, Users, Search, ChevronDown, LogOut, Menu, User as UserIcon } from "lucide-react";
...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-background flex w-full">
        ...
        <div className="flex flex-col h-full">
          <div className="h-[89px] border-b border-border flex items-center px-4 relative">
            ...
            <div className={cn(
              ...
              <p className="text-sm text-muted-foreground mt-1 whitespace-nowrap">Order Management</p>
            </div>
          </div>
      ...
      {/* Main content */}
      <div className={cn("flex-1 transition-all duration-200", sidebarCollapsed ? "lg:ml-20" : "lg:ml-64")}>
        {/* Header */}
